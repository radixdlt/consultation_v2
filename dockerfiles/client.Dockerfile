...
ENV VITE_VOTE_COLLECTOR_URL=$VITE_VOTE_COLLECTOR_URL
ENV VITE_PUBLIC_DAPP_DEFINITION_ADDRESS=$VITE_PUBLIC_DAPP_DEFINITION_ADDRESS
ENV VITE_PUBLIC_NETWORK_ID=$VITE_PUBLIC_NETWORK_ID
